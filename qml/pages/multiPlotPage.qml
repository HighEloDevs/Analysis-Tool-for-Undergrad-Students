                ...
                GridLayout{
                    ...
                    TextButton{
                        ...
                        onClicked:{
                            ...
                            data['options']['xmin'] = xmin.text
                            data['options']['xmax'] = xmax.text
                            data['options']['xdiv'] = xdiv.text
                            data['options']['ymin'] = ymin.text
                            data['options']['ymax'] = ymax.text
                            data['options']['ydiv'] = ydiv.text
